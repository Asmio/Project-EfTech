    ...
    <div class="copyright-bar">
        <div class="container">
            ...
            <ul class="nav navbar-nav navbar-right icons">
            	...
            	<c:choose>
            		<c:when test="${parametersURL.indexOf('&lang=') != -1}">
            		...
            		<c:otherwise>
            			<li><a href="?${parametersURL}&lang=ru"><img src="${pageContext.request.contextPath}/resources/assets/images/Russia.png"></a></li>
						<li><a href="?${parametersURL}&lang=en"><img src="${pageContext.request.contextPath}/resources/assets/images/United-Kingdom.png"></a></li>
            		</c:otherwise>
            	</c:choose>
			</ul>
            <div class="col-xs-12 col-sm-6 no-margin">
